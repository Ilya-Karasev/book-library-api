...
public class CommandLineRunnerImpl implements CommandLineRunner {
    ...
    private void seedData() throws IOException, InterruptedException {
        ...
        BookDto book1 = bookService.addBook(new BookDto(librarian, "Effective Java", "Joshua Bloch", "Addison-Wesley", 2018, "Программирование", 2, 5, "A must-read for Java developers"), librarian.getName());
        BookDto book2 = bookService.addBook(new BookDto(librarian, "Clean Code", "Robert C. Martin", "Prentice Hall", 2008,  "Программирование", 1, 4, "Guide to writing clean, maintainable code"), librarian.getName());
